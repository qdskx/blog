	...
	<div id="main">
		...
		<div class="wrapper clearfix">
			...
			<div id="content">
				...
				<?php foreach($postRes as $val):?>
				<div class="blog-post blog-post-single">

					<div class="blog-post-thumb">
						<!-- <img src="public/images/home/blog-posts/placeholder.jpg" alt="" /> -->
						...
						<div class="blog-post-info">
							...
							<div class="blog-post-info-inner">
								...
								<div class="blog-post-meta">
									<?php echo date('Y-m-d H:i:s' , $val['postime']);?>, In: <a href="index.php?m=details&a=single&cid=<?=$val['cid'];?>&tid=<?=$val['tid'];?>"><?=$val['classname'];?></a>
								</div><!-- .blog-post-meta -->
				...
				<?php if(!empty($postResAllpage)):?>
				<div class="pagination" style='margin-left:460px'>

					<a href="<?=$postResAllpage['first'];?>" class="current-pagination-item">首页</a>
					<a href="<?=$postResAllpage['prev'];?>">上一页</a>
					<a href="<?=$postResAllpage['next'];?>">下一页</a>
					<a href="<?=$postResAllpage['end'];?>">尾页</a>
				...
				<div class="white-wrap">
					...
					<form action="index.php?m=details&a=addPost&cid=<?=$_GET['cid'];?>" method="post" enctype="multipart/form-data">
						...
						<div class="leave-comment-message">
							<textarea name="content" placeholder="CONTENT" aria-required="true"></textarea>
						</div><!-- .leave-comment-message -->
						
						<div class="leave-comment-submit">
							<input name="submit" type="submit" id="submit" class="submit" value="发布你的文字" />
